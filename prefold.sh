...
python prefold.py --type "n-fold" --folds 3 --splitting "random" --inputDirectory ${NTUPLE_DIR} --outputDirectory ${FOLDED_DIR} --noRecurse
python prefold.py --type "n-fold" --folds 6 --splitting "random" --inputDirectory ${NTUPLE_DIR} --outputDirectory ${FOLDED_DIR} --noRecurse
